...
<select name="cash_type">
    <?php foreach($cashTypeArr as $value):?>
        <option value="<?php echo $value;?>" <?php echo ($value==$resume->cash_type)? 'selected' : ''?>><?php echo $value;?></option>
    <?php endforeach;?>
</select><br>
<b>Занятость</b><br>
<input type="checkbox" name="employment_full" <?php echo ($resume->employment_full)? 'checked' : ''?>> Полная занятость<br>
<input type="checkbox" name="employment_partial" <?php echo ($resume->employment_partial)? 'checked' : ''?>> Частичная занятость<br>
<input type="checkbox" name="employment_project" <?php echo ($resume->employment_project)? 'checked' : ''?>> Проектная работа<br>
<input type="checkbox" name="employment_volunteering" <?php echo ($resume->employment_volunteering)? 'checked' : ''?>> Волонтерство<br>
<input type="checkbox" name="employment_internship" <?php echo ($resume->employment_internship)? 'checked' : ''?>> Стажировка<br>

<b>Графика работы</b><br>
<input type="checkbox" name="schedule_full" <?php echo ($resume->schedule_full)? 'checked' : ''?>> Полный день <br>
<input type="checkbox" name="schedule_removable" <?php echo ($resume->schedule_removable)? 'checked' : ''?>> Сменный график <br>
<input type="checkbox" name="schedule_flexible" <?php echo ($resume->schedule_flexible)? 'checked' : ''?>> Гибкий график <br>
<input type="checkbox" name="schedule_tomote" <?php echo ($resume->schedule_tomote)? 'checked' : ''?>> 	Удаленная работа <br>
<input type="checkbox" name="schedule_tour" <?php echo ($resume->schedule_tour)? 'checked' : ''?>> 	Вахтовый метод <br>

<input type="submit" class="btn btn-success" value="Сохранить"> 
<a href="/resume/edit?id=<?php $resume->id?>" class="btn btn-primary">Отменить</a>
