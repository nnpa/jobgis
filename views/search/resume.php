...
<form method="GET">
    ...
    <div>
        <div style="width:30%;float:left;min-width: 220px;">
            ...
            <input type="radio" name="schedule" <?php echo ($schedule == "schedule_flexible")?'checked':''?> value="schedule_flexible">  Гибкий график<br>
            <input type="radio" name="schedule" <?php echo ($schedule == "schedule_tomote")?'checked':''?> value="schedule_tomote">   Удаленная работа<br>
            <input type="radio" name="schedule" <?php echo ($schedule == "schedule_tour")?'checked':''?> value="schedule_tour">   Вахтовый метод<br>
            
        </div>
        <div style="width:70%;float:left">
            <?php foreach($result as $row):?>
                <a target="_blank" href="/resume/show?id=<?php echo $row["id"];?>"><?php echo $row["vacancy"];?> </a><?php echo $row["city"];?> <?php echo $resume->age($row["birth_date"]);?><br>
