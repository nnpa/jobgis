...
class SearchController extends AppController
{
    ...
    public function actionTop($top){
        ...
        $sql = "select city,name,surname, id, (select COUNT(*) from firm where manage_id = Users.id AND firm.create_time > $time) as cnt from Users where type = 4 AND cnt > 0 AND recruiter_info is not null order by cnt limit 100;";
